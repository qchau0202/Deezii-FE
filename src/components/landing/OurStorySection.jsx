...
const OurStorySection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="ourstory-section"
      className="min-h-screen flex flex-col justify-center bg-gray-50 py-16 md:py-20"
    >
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-12 gap-6 text-center">
          <div className="col-span-12">
            ...
            <p className="text-sm md:text-lg text-gray-600 mb-6 md:mb-10 max-w-3xl mx-auto">
              {t.description}
            </p>
          </div>
          <div className="col-span-12">
            <div className="flex justify-center items-center gap-2 text-base md:text-xl text-gray-700 mb-10 md:mb-14">
              <span className="font-bold text-2xl md:text-4xl text-indigo-600">
                {isVisible && (
                  <>
                    <CountUp
                      from={0}
            ...
            <div className="grid grid-cols-12 gap-4 md:gap-6 justify-items-center">
              {t.testimonials.map((item, index) => (
                <div key={index} className="col-span-12 sm:col-span-6 md:col-span-4">
                  <div className="p-6 md:p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-center flex flex-col transform hover:-translate-y-2 max-w-sm mx-auto">
